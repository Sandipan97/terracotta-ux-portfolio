...
const PGDataloggerProject = () => {
  ...
  const components = [
    "Login Modal", "Time/Date Picker", "Alarm Settings", "Data Capture Rate",
    "Buffer Size Controls", "Device Sensitivity", "Port Configuration", 
    "Developer Options", "Format Modal", "Device Status", "Auto-reconnect Toggle"
  ];
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <Zap className="w-8 h-8" />, title: "Performance", desc: "Improve power efficiency and speed" },
              { icon: <Eye className="w-8 h-8" />, title: "Accessibility", desc: "Enhance user-friendliness for all users" },
              { icon: <Shield className="w-8 h-8" />, title: "Reliability", desc: "Ensure stability and scalability" },
              { icon: <BarChart3 className="w-8 h-8" />, title: "Evaluation", desc: "Conduct heuristic assessment" },
              { icon: <Clock className="w-8 h-8" />, title: "Journey Mapping", desc: "Identify user friction points" },
              { icon: <CheckCircle className="w-8 h-8" />, title: "Integration", desc: "Audit UI and hardware connection" }
            ].map((goal, index) => (
              <motion.div
                key={index}
                initial="initial"
              ...
              <Card className="p-8">
                ...
                <CardContent className="space-y-4">
                  {[
                    ...
                    "UI audit for layout, interaction, and visual hierarchy",
                    "UX audit for design standards compliance",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { metric: "40%", label: "Faster Task Completion", icon: <Clock className="w-6 h-6" /> },
              { metric: "95%", label: "Clearer Navigation", icon: <BarChart3 className="w-6 h-6" /> },
              { metric: "100%", label: "Theme Accessibility", icon: <Shield className="w-6 h-6" /> },
              { metric: "75%", label: "Real-time Feedback", icon: <Zap className="w-6 h-6" /> }
            ].map((impact, index) => (
              <motion.div
                key={index}
                initial="initial"
              ...
              <Card className="p-4">
                ...
                <CardContent>
                  <EditableImage
                    ...
                    alt="Final P&G Research Razor 2.0 interface in dark mode"
                    className="w-full h-[400px] object-cover rounded-lg"
                    fallbackSrc="/placeholder.svg"
                  />
                </CardContent>
