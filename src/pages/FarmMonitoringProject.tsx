      ...
      <main className="pt-20">
        ...
        <section id="hero" className="w-full relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <motion.div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-green-500/10 filter blur-3xl" animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.6, 0.3]
          }} transition={{
            duration: 8,
            ...
            <motion.div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-emerald-500/10 filter blur-3xl" animate={{
            scale: [1, 1.3, 1],
            opacity: [0.2, 0.5, 0.2]
          }} transition={{
            duration: 12,
            ...
            <motion.div className="absolute top-1/2 left-1/4 w-64 h-64 rounded-full bg-teal-500/5 filter blur-2xl" animate={{
            x: [0, 50, 0],
            y: [0, -30, 0]
          }} transition={{
            duration: 15,
          ...
          duration: 0.5
            ...
            <Button onClick={goBack} variant="secondary" className="bg-background/80 backdrop-blur-sm border border-border/50 hover:bg-background hover:scale-105 transition-all duration-300 shadow-lg" size="icon" data-lovable-editable="back-button">
              <ArrowLeft size={20} />
            </Button>
          </motion.div>
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 h-full flex items-center">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full max-h-[80vh]">
              ...
              duration: 0.8
                ...
                {/* Main Title */}
                <motion.h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground leading-tight" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                {/* Subtitle */}
                <motion.p className="text-lg sm:text-xl text-muted-foreground leading-relaxed" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                delay: 0.8
                  ...
                  <Button className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-6 py-3 text-base group" onClick={() => document.getElementById('overview')?.scrollIntoView({
                  behavior: 'smooth'
                })} data-lovable-editable="hero-primary-button">
                    Explore the Journey
                    <motion.div className="ml-2 group-hover:translate-x-1 transition-transform duration-200" animate={{
                    x: [0, 3, 0]
                  }} transition={{
                    duration: 2,
                    repeat: Infinity
                  ...
                  <Button variant="outline" className="border-green-300 text-green-700 hover:bg-green-50 hover:border-green-400 px-6 py-3 text-base transition-all duration-300 dark:border-green-700 dark:text-green-300 dark:hover:bg-green-900/20" onClick={() => document.getElementById('demo')?.scrollIntoView({
                  behavior: 'smooth'
                ...
                <motion.div className="hidden sm:grid grid-cols-2 lg:grid-cols-4 gap-4 pt-6 lg:pt-8" initial={{
                opacity: 0,
                y: 30
              }} animate={{
                opacity: 1,
              ...
              <motion.div className="relative max-w-2xl mx-auto lg:mx-0" initial={{
              opacity: 0,
              scale: 0.9
            }} animate={{
              opacity: 1,
              ...
              duration: 0.8
                ...
                <div className="relative rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 p-3 lg:p-6">
                  ...
                  {/* App Showcase Image */}
                  <EditableImage src="/lovable-uploads/f4d57f92-208a-4c6c-96e9-7b59286e0167.png" alt="Farm Monitoring App Showcase - Multiple mobile screens showing dashboard, personalized crop data, and analytics" className="w-full h-auto object-contain rounded-xl lg:rounded-2xl max-h-[50vh] lg:max-h-[60vh]" priority="critical" fallbackSrc="/placeholder.svg" />
                  
                  {/* Floating Info Cards */}
                  <motion.div className="absolute -top-2 -right-2 lg:-top-4 lg:-right-4 bg-green-500 text-white px-2 py-1 lg:px-4 lg:py-2 rounded-full text-xs lg:text-sm font-semibold shadow-lg" animate={{
                  y: [-5, 5, -5]
                }} transition={{
                  duration: 3,
                  repeat: Infinity,
                  ...
                  <motion.div className="absolute -bottom-2 -left-2 lg:-bottom-4 lg:-left-4 bg-emerald-500 text-white px-2 py-1 lg:px-4 lg:py-2 rounded-full text-xs lg:text-sm font-semibold shadow-lg" animate={{
                  y: [5, -5, 5]
                }} transition={{
                  duration: 4,
                  repeat: Infinity,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="space-y-6">
                  {[{
                  name: "Rajesh Kumar",
                  type: "Small-scale Wheat Farmer",
                  pain: "Weather unpredictability"
                }, {
                  name: "Priya Sharma",
                  type: "Organic Vegetable Grower",
                  pain: "Soil health monitoring"
                }, {
                  name: "Mohammed Ali",
                  type: "Large-scale Cotton Farmer",
                  pain: "Resource optimization"
                }].map((persona, index) => <motion.div key={persona.name} className="bg-card border border-border rounded-lg p-4" initial={{
                  opacity: 0,
                  x: -20
                }} whileInView={{
                  opacity: 1,
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[{
                  title: "Says",
                  content: "Weather is unpredictable",
                  color: "bg-blue-100 dark:bg-blue-900/20"
                }, {
                  title: "Thinks",
                  content: "Technology is complex",
                  color: "bg-green-100 dark:bg-green-900/20"
                }, {
                  title: "Does",
                  content: "Checks fields daily",
                  color: "bg-yellow-100 dark:bg-yellow-900/20"
                }, {
                  title: "Feels",
                  content: "Anxious about crops",
                  color: "bg-red-100 dark:bg-red-900/20"
                }].map(item => <motion.div key={item.title} className={`${item.color} border border-border rounded-lg p-4`} initial={{
                  opacity: 0,
                  scale: 0.9
                }} whileInView={{
                  opacity: 1,
        ...
        <section id="problem" className="py-16 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {["How might we make weather data more accessible?", "How might we simplify soil health monitoring?", "How might we reduce crop loss anxiety?", "How might we optimize water usage?", "How might we connect farmers to experts?", "How might we make farming more predictable?"].map((question, index) => <motion.div key={index} className="bg-yellow-200 dark:bg-yellow-800/30 border-l-4 border-yellow-500 p-4 rounded-r-lg transform rotate-1 hover:rotate-0 transition-transform" initial={{
              opacity: 0,
              y: 20,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[{
                  concept: "Weather Alert System",
                  votes: 12
                }, {
                  concept: "Soil Health Dashboard",
                  votes: 10
                }, {
                  concept: "Expert Chat Integration",
                  votes: 8
                }, {
                  concept: "Crop Calendar Planner",
                  votes: 7
                }].map((sketch, index) => <motion.div key={sketch.concept} className="bg-card border border-border rounded-lg p-4 flex justify-between items-center" initial={{
                  opacity: 0,
                  x: -20
                }} whileInView={{
                  opacity: 1,
                  ...
                  once: true
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex">
                          {Array.from({
                        length: Math.min(sketch.votes, 5)
                      }).map((_, i) => <div key={i} className="w-2 h-2 bg-purple-500 rounded-full mr-1"></div>)}
                        </div>
                      </div>
                    </motion.div>)}
                </div>
              ...
              <div>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  <div className="space-y-4">
                    ...
                    feature: "Soil Moisture Tracking",
                    priority: "High",
                    dots: 13
                  }, {
                    ...
                    feature: "Market Price Updates",
                    priority: "Low",
                    dots: 5
                  }].map((item, index) => <motion.div key={item.feature} className="flex justify-between items-center" initial={{
                    opacity: 0,
                    y: 10
                  }} whileInView={{
                    opacity: 1,
                    ...
                    once: true
                        ...
                        <div>
                          ...
                          <Badge className={`text-xs ${item.priority === 'High' ? 'bg-red-100 text-red-800' : item.priority === 'Medium' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'}`}>
                            {item.priority}
                          </Badge>
                        </div>
                        <div className="flex items-center gap-1">
                          {Array.from({
                        length: Math.min(item.dots, 10)
                      }).map((_, i) => <div key={i} className="w-3 h-3 bg-purple-500 rounded-full"></div>)}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="relative bg-card border border-border rounded-lg p-6 h-80">
                  ...
                  <motion.div className="absolute top-16 left-16 bg-green-500 text-white px-2 py-1 rounded text-xs" initial={{
                  scale: 0
                }} whileInView={{
                  scale: 1
                }} transition={{
                  ...
                  <motion.div className="absolute top-20 right-20 bg-blue-500 text-white px-2 py-1 rounded text-xs" initial={{
                  scale: 0
                }} whileInView={{
                  scale: 1
                }} transition={{
                  ...
                  <motion.div className="absolute bottom-20 left-20 bg-yellow-500 text-white px-2 py-1 rounded text-xs" initial={{
                  scale: 0
                }} whileInView={{
                  scale: 1
                }} transition={{
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  phase: "Awareness",
                  emotion: "😟",
                  action: "Realizes crop issues"
                }, {
                  phase: "Research",
                  emotion: "🤔",
                  action: "Searches for solutions"
                }, {
                  phase: "Trial",
                  emotion: "😊",
                  ...
                  phase: "Adoption",
                  emotion: "😍",
                  action: "Uses daily monitoring"
                }, {
                  phase: "Advocacy",
                  emotion: "🥳",
                  action: "Recommends to others"
                }].map((step, index) => <motion.div key={step.phase} className="flex items-center gap-4 bg-card border border-border rounded-lg p-4" initial={{
                  opacity: 0,
                  x: -20
                }} whileInView={{
                  opacity: 1,
        ...
        <section id="demo" className="py-8 lg:py-16 bg-gradient-to-br from-green-600 to-emerald-600">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="lg:hidden space-y-8">
                ...
                once: true
                  ...
                  <h2 className="font-heading text-3xl md:text-4xl font-bold text-white mb-4" data-lovable-editable="demo-title">
                    Interactive App Demo
                  </h2>
                  <p className="text-lg text-green-100 max-w-2xl mx-auto" data-lovable-editable="demo-subtitle">
                    Experience the farmer-centered design in action
                  </p>
                </motion.div>

                {/* App Screen Mockups */}
                <motion.div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto" initial={{
                opacity: 0,
                y: 30
              }} whileInView={{
                opacity: 1,
                ...
                once: true
                  ...
                  once: true
                    ...
                    <div className="bg-white rounded-xl p-3 shadow-xl mb-3 aspect-[9/16] flex items-center justify-center">
                      <EditableImage src="/lovable-uploads/92daa44f-f4d1-472d-8910-22e82bf8b3b3.png" alt="Dashboard Screen" className="w-full h-full object-contain rounded-lg" fallbackSrc="/placeholder.svg" />
                    </div>
                  ...
                  once: true
                    ...
                    <div className="bg-white rounded-xl p-3 shadow-xl mb-3 aspect-[9/16] flex items-center justify-center">
                      <EditableImage src="/lovable-uploads/50eedb00-deb6-4ad4-9d4a-a664044ae725.png" alt="Personalized for your crop" className="w-full h-full object-contain rounded-lg" fallbackSrc="/placeholder.svg" />
                    </div>
                  ...
                  once: true
                    ...
                    <div className="bg-white rounded-xl p-3 shadow-xl mb-3 aspect-[9/16] flex items-center justify-center">
                      <EditableImage src="/lovable-uploads/13fd507a-045d-444e-8db5-b79ac6d8b548.png" alt="Accurate location & Analytics" className="w-full h-full object-contain rounded-lg" fallbackSrc="/placeholder.svg" />
                    </div>
                ...
                {/* Video Demo */}
                <motion.div className="rounded-2xl overflow-hidden shadow-2xl bg-black max-w-2xl mx-auto" initial={{
                opacity: 0,
                scale: 0.9
              }} whileInView={{
                opacity: 1,
                ...
                once: true
                  ...
                  position: "relative"
                    ...
                    <iframe src="https://player.vimeo.com/video/1112123237?badge=0&autopause=0&player_id=0&app_id=58479&autoplay=1&muted=1&loop=1&dnt=1" frameBorder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerPolicy="strict-origin-when-cross-origin" style={{
                    position: "absolute",
                    top: 0,
                    left: 0,
                    width: "100%",
              ...
              <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-start lg:min-h-[100vh]">
                ...
                once: true
                  ...
                  <div className="text-left">
                    <h2 className="font-heading text-4xl xl:text-5xl font-bold text-white mb-4" data-lovable-editable="demo-title">
                      Interactive App Demo
                    </h2>
                    <p className="text-lg text-green-100" data-lovable-editable="demo-subtitle">
                      Experience the farmer-centered design in action
                    </p>
                  </div>

                  {/* App Screen Mockups - Horizontal Layout */}
                  <motion.div className="grid grid-cols-3 gap-6" initial={{
                  opacity: 0,
                  y: 30
                }} whileInView={{
                  opacity: 1,
                ...
                {/* Right Column - Video */}
                <motion.div className="rounded-2xl overflow-hidden shadow-2xl bg-black" initial={{
                opacity: 0,
                x: 30
              }} whileInView={{
                opacity: 1,
        ...
        <section id="practices" className="py-16 bg-green-50 dark:bg-green-950/20">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              icon: "🤝"
            }].map((practice, index) => <motion.div key={practice.title} className="bg-card border border-border rounded-xl p-6" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
        ...
        <section id="outcomes" className="py-16 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              icon: "💧"
            }].map((stat, index) => <motion.div key={stat.label} className="text-center bg-card border border-border rounded-xl p-6" initial={{
              opacity: 0,
              scale: 0.9
            }} whileInView={{
              opacity: 1,
            ...
            {/* Workshop Feedback */}
            <motion.div className="bg-green-100 dark:bg-green-900/20 rounded-2xl p-8 text-center" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            once: true
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button className="bg-white text-green-600 hover:bg-green-50 hover:text-green-700 px-8 py-3 text-lg" onClick={() => navigate('/contact')} data-lovable-editable="cta-primary-button">
