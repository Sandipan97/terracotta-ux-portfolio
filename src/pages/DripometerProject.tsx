          ...
          <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
            ...
            delay: 0.2
              ...
              <div className="flex flex-wrap gap-3 mb-8 justify-center">
                ...
                icon: "📊",
                color: "cyan"
              }].map((badge, index) => <motion.div key={badge.label} initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
              ...
              <motion.h1 className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-foreground" initial={{
              opacity: 0,
              y: 30
            }} animate={{
              opacity: 1,
              ...
              <motion.p className="text-lg md:text-xl max-w-4xl mx-auto leading-relaxed text-muted-foreground mb-8" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                icon: "👨‍🎨"
              }].map((item, index) => <motion.div key={item.label} className="bg-card border border-border p-6 rounded-xl hover:bg-muted/50 transition-all duration-300" initial={{
                opacity: 0,
                y: 30
              }} animate={{
                opacity: 1,
