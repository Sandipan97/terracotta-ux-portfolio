      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white/70 hover:text-bengali-terracotta transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-white/70 hover:text-bengali-terracotta transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-white/70 hover:text-bengali-terracotta transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link to="/projects" className="text-white/70 hover:text-bengali-terracotta transition-colors">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white/70 hover:text-bengali-terracotta transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <Button 
            ...
            size="icon"
            onClick={scrollToTop}
            className="border-white/30 text-white hover:bg-white hover:text-bengali-dark rounded-full"
