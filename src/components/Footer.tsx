...
const Footer = () => {
  ...
  return (
    <footer className="bg-bengali-dark dark:bg-background text-white dark:text-foreground border-t dark:border-border">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white/70 dark:text-muted-foreground hover:text-bengali-terracotta dark:hover:text-bengali-terracotta-light transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-white/70 dark:text-muted-foreground hover:text-bengali-terracotta dark:hover:text-bengali-terracotta-light transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-white/70 dark:text-muted-foreground hover:text-bengali-terracotta dark:hover:text-bengali-terracotta-light transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link to="/projects" className="text-white/70 dark:text-muted-foreground hover:text-bengali-terracotta dark:hover:text-bengali-terracotta-light transition-colors">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white/70 dark:text-muted-foreground hover:text-bengali-terracotta dark:hover:text-bengali-terracotta-light transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 dark:border-border pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <Button 
            ...
            size="icon"
            onClick={scrollToTop}
            className="border-white/30 dark:border-border text-white dark:text-foreground hover:bg-white hover:text-bengali-dark dark:hover:bg-card dark:hover:text-foreground rounded-full"
