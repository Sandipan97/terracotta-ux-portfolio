...
interface UniversalStickyNavigationProps {
  sections: NavigationSection[];
  className?: string;
}

const UniversalStickyNavigation = ({ sections, className = "" }: UniversalStickyNavigationProps) => {
...
export default UniversalStickyNavigation;
