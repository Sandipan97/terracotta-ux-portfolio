        ...
        >
          ...
          <div className="space-y-16">
            {detailedSolutions.map((solution, index) => {
              ...
              return (
                ...
                >
                  <Card className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 border-blue-500/30 backdrop-blur-sm overflow-hidden">
                    <CardHeader className="pb-8">
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                          <CardTitle className="text-white text-2xl md:text-3xl mb-2">{solution.title}</CardTitle>
                          <p className="text-blue-300 text-lg">{solution.subtitle}</p>
                        </div>
                        <div className="w-16 h-16 bg-slate-600/50 rounded-xl flex items-center justify-center border border-slate-500/50">
                    ...
                    <CardContent className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
                          ...
                          <p className="text-gray-300 leading-relaxed">{solution.challenge}</p>
                        </div>
                      ...
                      {/* Technologies */}
                      <div>
                        <h4 className="text-white font-semibold mb-4">Technologies & Methods</h4>
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-slate-800/50 rounded-full border border-blue-500/30">
              <span className="text-gray-300 text-sm">Ready to see the impact?</span>
