    ...
    >
      ...
      >
        <motion.span 
          ...
          className="relative inline-block py-0 my-[20px] text-yellow-400"
        ...
        <motion.span 
          ...
          data-lovable-editable="hero-intro"
        >
          I am
        </motion.span>
        <br />
        <span className="relative inline-block text-5xl sm:text-6xl lg:text-7xl py-0 my-[16px]">
          ...
          >
            {displayText}
            <motion.span 
              className="inline-block w-1 h-16 sm:h-20 bg-bengali-terracotta-dark dark:bg-red-500 ml-1" 
              animate={{ opacity: [1, 0, 1] }} 
              transition={{ duration: 1, repeat: Infinity }} 
            />
          </motion.span>
          <motion.span 
            className="absolute -bottom-1 left-0 h-1 bg-bengali-terracotta-dark dark:bg-red-500" 
            initial={{ width: 0 }} 
      ...
      >
        <div className="bg-white/80 backdrop-blur-md border border-white/30 rounded-xl p-4 shadow-lg">
          <p 
            className="text-base md:text-lg max-w-md text-black"
