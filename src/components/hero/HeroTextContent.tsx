    ...
    ease: "easeOut"
      ...
      duration: 0.6
        ...
        scale: 0.95
          ...
          <Button onClick={scrollToProjects} className="bg-bengali-terracotta hover:bg-bengali-terracotta/90 text-white font-semibold px-6 py-3 h-12 rounded-lg border-2 border-white shadow-md hover:shadow-lg transform transition-all duration-300 dark:bg-bengali-terracotta dark:hover:bg-bengali-terracotta/90 dark:border-white">
            View My Work
          </Button>
        </motion.div>
