    ...
    >
      ...
      >
        <motion.span 
          ...
          className="relative inline-block py-0 mb-1 text-2xl sm:text-3xl text-warm-rust leading-tight"
        >
      ...
      <motion.div 
        className="mb-4 md:mb-6 w-full flex justify-center md:justify-start"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.div 
        className="flex flex-wrap gap-3 md:gap-4 justify-center md:justify-start w-full"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
