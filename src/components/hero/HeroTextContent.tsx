      ...
      >
        ...
        >
          <Button 
            ...
            className="transition-all duration-300 shadow-lg hover:shadow-xl text-rose-600 text-xl bg-yellow-400 hover:bg-yellow-300"
          >
            View My Work
          </Button>
        </motion.div>
        ...
        >
          <Button 
            className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105 border-2 border-red-600 hover:border-red-700 dark:bg-red-500 dark:hover:bg-red-600 dark:border-red-500 dark:hover:border-red-600" 
            asChild
          >
        ...
        >
          <Button 
            variant="outline"
            className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105 border-2 border-blue-600 hover:border-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 dark:border-blue-500 dark:hover:border-blue-600 flex items-center gap-2" 
            asChild
          >
