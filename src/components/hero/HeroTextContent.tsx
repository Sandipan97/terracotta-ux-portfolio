    ...
    ease: "easeOut"
      ...
      duration: 0.6
        ...
        scale: 0.95
          ...
          <Button className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105 border-2 border-red-600 hover:border-red-700 dark:bg-red-500 dark:hover:bg-red-600 dark:border-red-500 dark:hover:border-red-600" asChild>
