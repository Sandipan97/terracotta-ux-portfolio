    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <motion.h1 
              className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-bengali-dark mb-6"
            ...
            <motion.p 
              className="text-lg text-bengali-dark/80 mb-8 max-w-md"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  ...
                  className="bg-bengali-mustard text-bengali-terracotta hover:bg-bengali-mustard/90 transition-all duration-300"
                >
                  View My Work
                </Button>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  variant="outline" 
                  className="border-bengali-terracotta text-bengali-terracotta hover:bg-bengali-terracotta hover:text-white transition-all duration-300" 
                  asChild
                >
          ...
          >
            <div className="relative">
              ...
              <motion.div 
                className="absolute -bottom-4 -right-4 text-bengali-dark px-6 py-3 rounded-full font-medium bg-white backdrop-blur-md border border-white/20 shadow-lg"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
