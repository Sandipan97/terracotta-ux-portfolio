      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <Card className="overflow-hidden border-emerald-200 dark:border-emerald-800">
            <CardHeader className="bg-emerald-100 dark:bg-emerald-900/40">
            ...
            <CardContent className="p-0">
              <div className="relative h-80 overflow-hidden">
                <EditableImage
                  src={systemDiagram.image}
                  alt={systemDiagram.alt}
        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { metric: "99.7%", label: "Accuracy Rate", color: "emerald" },
              { metric: "48h", label: "Battery Life", color: "blue" },
              { metric: "<500ms", label: "Response Time", color: "purple" },
              { metric: "256-bit", label: "Encryption", color: "red" }
            ].map((item, index) => (
              <motion.div
                key={index}
                className="text-center p-6 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl"
