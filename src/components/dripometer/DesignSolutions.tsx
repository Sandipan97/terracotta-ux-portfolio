            ...
            <AccordionItem value="design-solutions" className="border border-teal-200/50 rounded-2xl px-6 bg-teal-50/30 dark:bg-teal-900/10 dark:border-teal-800/50">
              ...
              <AccordionContent className="pb-6">
                <div className="space-y-6">
                  {solutions.map((solution, index) => <motion.div key={index} className="bg-background/60 rounded-lg p-5 border border-teal-200/30 dark:border-teal-800/30" initial={{
                  opacity: 0,
                  x: -20
                }} whileInView={{
                  opacity: 1,
                  ...
                  once: true
                      ...
                      <ul className="space-y-2">
                        {solution.items.map((item, itemIndex) => <li key={itemIndex} className="text-muted-foreground text-sm flex items-start">
