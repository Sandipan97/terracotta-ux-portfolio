...
const DesignSolutions = () => {
  ...
  return <section id="solutions" className="py-16 bg-muted/20">
              ...
              <AccordionContent className="pb-6">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {solutions.map((solution, index) => <motion.div key={index} className="bg-background/60 rounded-lg p-4 border border-teal-200/30 dark:border-teal-800/30 h-full" initial={{
                    opacity: 0,
                    x: -20
                  }} whileInView={{
                    opacity: 1,
                    ...
                    once: true
                        ...
                        <ul className="space-y-1.5">
                          {solution.items.map((item, itemIndex) => <li key={itemIndex} className="text-muted-foreground text-xs flex items-start leading-tight">
                  ...
                  <motion.div className="space-y-6 mt-8" initial={{
                  opacity: 0,
                  y: 20
                }} whileInView={{
                  opacity: 1,
