...
import { Target, Search, Lightbulb, TrendingUp, Eye } from 'lucide-react';
...
export const StickyNavigation = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 bg-slate-900/90 backdrop-blur-sm border border-indigo-500/30 rounded-full px-2 py-2"
    >
